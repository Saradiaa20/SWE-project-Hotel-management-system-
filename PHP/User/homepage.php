...
<header>
    <div class="navbar">
        ...
        <div class="user-icon">
        <img src="user.png" alt="A person icon">
...
<div class="swiper mySwiper">
    ...
    <div class="swiper-slide"><img src="photo1.jpg" alt="Slide 1"></div>
    <div class="swiper-slide"><img src="photo2.jpg" alt="Slide 2"></div>
        <div class="swiper-slide"><img src="photo3.jpg" alt="Slide 3"></div>
        <div class="swiper-slide"><img src="photo4.jpg" alt="Slide 4"></div>
        <div class="swiper-slide"><img src="photo5.jpg" alt="Slide 5"></div>
    </div>
        ...
        <form>
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control shadow-none" value="<?php echo $today; ?>">
                </div>

                <div class="form-group">
                    <label class="form-label">Departure Date</label>
                    <input type="date" class="form-control shadow-none" value="<?php echo $tomorrow; ?>">
                </div>
