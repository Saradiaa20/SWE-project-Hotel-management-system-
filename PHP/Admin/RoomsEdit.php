      ...
      <div class="room-pictures">
        ...
        <div class="gallery">
          <div class="image-container">
            ...
            <button class="remove-image" onclick="removeImage(this)"><i class="fas fa-trash-alt"></i></button>

          </div>
          <div class="image-container">
            <img src="room2.jpg" alt="Room Image">
            <button class="remove-image" onclick="removeImage(this)"><i class="fas fa-trash-alt"></i></button>
          </div>
          <div class="image-container">
            <img src="room3.jpg" alt="Room Image">
            <button class="remove-image" onclick="removeImage(this)"><i class="fas fa-trash-alt"></i></button>
          </div>
          <div class="image-container">
            <img src="room4.jpg" alt="Room Image">
            <button class="remove-image" onclick="removeImage(this)"><i class="fas fa-trash-alt"></i></button>
          </div>
